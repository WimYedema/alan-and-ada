...
If the members should be aliased under a different name (namespaced) such as
`ex.Feature.*`, you can import-export the members as a new name:
...
Here are the guidelines applied in a sample commit message, along with some
...
Excalibur uses Storybook for writing visual tests and examples. These can be
interactive and showcase different parts of the engine or specific features. We
sometimes embed these examples in the documentation site.
